...
```{r}
print_paired_results(data, time = "30초")
```
...
```{r}
print_paired_results(data, time = "1분")
```
...
```{r}
print_paired_results(data, time = "2분")
```
...
```{r}
print_paired_results(data, time = "4분")
```
